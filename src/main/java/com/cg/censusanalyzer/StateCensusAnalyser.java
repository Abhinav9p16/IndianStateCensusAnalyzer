        ...
        try (Reader reader = Files.newBufferedReader(Paths.get(SAMPLE_CSV_FILE_PATH));)
        {
            ...
            while (csvUserIterator.hasNext()) {
                ...
                if(state.getSrNo() == null || state.getStateName() == null || state.getTIN() == null
                    ...
                    throw new CustomException(CustomException.ExceptionType.BINDING_PROBLEM_AT_RUNTIME,"delimeter incorrect or Header incorrect or Binding problem at runtime");
                }
            }
